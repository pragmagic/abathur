...
type
  IntervalHandle* {.importc.} = ref object of RootObj

proc setInterval*(action: proc(); ms: int): IntervalHandle {.
  importc, nodecl, discardable.}
proc clearInterval*(t: IntervalHandle) {.importc, nodecl.}
